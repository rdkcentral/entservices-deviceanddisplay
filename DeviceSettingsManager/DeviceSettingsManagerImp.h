...
namespace Plugin {
    ...
    public:
        ...
        // FPD methods
        virtual Core::hresult Register(Exchange::IDeviceSettingsManagerFPD::INotification* notification) override;
        virtual Core::hresult Unregister(Exchange::IDeviceSettingsManagerFPD::INotification* notification) override;
        ...
        // HDMIIn methods
        virtual Core::hresult Register(Exchange::IDeviceSettingsManagerHDMIIn::INotification* notification) override;
        virtual Core::hresult Unregister(Exchange::IDeviceSettingsManagerHDMIIn::INotification* notification) override;
    ...
    private:
        ...
        std::list<Exchange::IDeviceSettingsManagerHDMIIn::INotification*> _HDMIInNotifications;
