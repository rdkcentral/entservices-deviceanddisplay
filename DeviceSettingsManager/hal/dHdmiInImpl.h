...
static std::function<void(WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIInPort, WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIInSignalStatus)> g_HdmiInSignalStatusCallback;
static std::function<void(WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIInPort, WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIVideoPortResolution)> g_HdmiInVideoModeUpdateCallback;
static std::function<void(WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIInPort, bool)> g_HdmiInAllmStatusCallback;
static std::function<void(WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIInPort, WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIInAviContentType)> g_HdmiInAviContentTypeCallback;
static std::function<void(int32_t, int32_t)> g_HdmiInAVLatencyCallback;
static std::function<void(WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIInPort, WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIInVRRType)> g_HdmiInVRRStatusCallback;
static std::function<void(WPEFramework::Exchange::IDeviceSettingsManagerHDMIIn::HDMIInPort, bool)> g_HdmiInStatusCallback;
