...
v_secure_system(const char* command, ...);

__attribute__((nonnull))
__attribute__((format(printf, 2, 3)))
FILE*
v_secure_popen(const char* direction, const char* command, ...);

__attribute__((nonnull)) int v_secure_pclose(FILE*);
...
#define v_secure_popen(direction, fmt, args...)                                                                                           \
    ({                                                                                                                                    \
        ...
        PRAGMA_PUSH;                                                                                                                      \
        if (                                                                                                                              \
            __builtin_constant_p(*direction) && ((direction[0] != 'r' && direction[0] != 'w') || direction[1] != '\0')) {                 \
...
__attribute__((warning("contains_secure_separator is obsolete"))) static inline int
contains_secure_separator(__attribute__((unused)) char* str)
{
    return 0;
}
