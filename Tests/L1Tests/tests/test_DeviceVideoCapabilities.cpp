...
TEST_F(DeviceVideoCapabilitiesTest, Constructor_Success_ManagerInitializeSuccess)
{
...
TEST_F(DeviceVideoCapabilitiesTest, Constructor_HandlesDeviceException_ManagerInitializeThrows)
{
...
TEST_F(DeviceVideoCapabilitiesTest, Constructor_HandlesStdException_ManagerInitializeThrows)
{
...
TEST_F(DeviceVideoCapabilitiesTest, Constructor_HandlesUnknownException_ManagerInitializeThrows)
{
    ...
    EXPECT_CALL(*testManagerMock, Initialize())
        .WillOnce(Invoke([]() {
            throw 456; // Unknown exception type
        }));
