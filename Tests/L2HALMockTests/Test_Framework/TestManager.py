...
# Activating the HdmiCecSource plugin using controller1.activate curl command
    ...
    if "PowerManager" in plugin_name:
        ...
        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_001_PowerManager_getOvertempGraceInterval

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_002_PowerManager_getPowerState  # commented as its descoped in source code

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_003_PowerManager_getThermalState

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_004_PowerManager_getTemperatureThresholds
        ...
        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_005_PowerManager_setOvertempGraceInterval  # commented as its descoped in source code

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_006_PowerManager_setPowerState

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_007_PowerManager_setDeepSleepTimer

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_008_PowerManager_getLastWakeupReason

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_009_PowerManager_getLastWakeupKeyCode

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_010_PowerManager_reboot

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_011_PowerManager_getNetworkStandbyMode

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_012_PowerManager_setNetworkStandbyMode

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_013_PowerManager_setWakeupSrcConfig

        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_014_PowerManager_getWakeupSrcConfig
        ...
        print("Skipping PowerManager as no changes are added")
...
if "PowerManager" in argument or "PowerManager" in result:
    if track < 2:
        flag = 5
        Utils.info_log("Executing PowerManager Test suite")
        print(
            "\033[32m------########################################################################################################################---------.\033[0m")
        import TCID_001_PowerManager_getOvertempGraceInterval
