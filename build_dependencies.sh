...
git clone --branch feature/RDKEMW-7722 https://github.com/rdkcentral/entservices-apis.git

git clone --branch feature/RDKEMW-7722 https://$GITHUB_TOKEN@github.com/rdkcentral/entservices-testframework.git
