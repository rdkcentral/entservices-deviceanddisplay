...
git clone --branch topic/RDKEMW-3229 https://github.com/rdkcentral/entservices-apis.git

git clone --branch topic/RDKEMW-3226 https://$GITHUB_TOKEN@github.com/rdkcentral/entservices-testframework.git
